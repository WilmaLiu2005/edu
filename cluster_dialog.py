...
if args.visualize: 
    ...
    plt.title(f"Dialog Clustering ({args.algorithm})") 
    plt.colorbar(scatter) 
    safe_model_name = args.embedding_model.replace("/", "_") 
    fig_path = f"cluster_visualization_{args.algorithm}_{args.dimred}_{args.embedding_mode}_{args.n_clusters}.png" 
